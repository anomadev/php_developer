...
class RepositoryControllerTest extends TestCase
{
    ...
    public function test_store()
    {
        ...
        $this->actingAs($user)->post('repositories', $data)
    ...
    public function test_validate_store()
    {
        ...
        $this->actingAs($user)->post('repositories', [])
            ->assertStatus(302)
    ...
    public function test_validate_update()
    {
        ...
        $this->actingAs($user)->put("repositories/$repository->id", [])
            ->assertStatus(302)
            ->assertSessionHasErrors(['url', 'description']);
    }
    ...
    public function test_edit()
    {
        ...
        $this->actingAs($user)->get("repositories/$repository->id/edit")
            ->assertStatus(200)
            ->assertSee($repository->url)
    ...
    public function test_create()
    {
        ...
        $this->actingAs($user)->get('repositories/create')
            ->assertStatus(200);
    }
}
